  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="relative" ref={columnsRef}>
        <button
          className="flex items-center gap-2 rounded-xl border bg-white/[0.04] px-4 py-2.5 text-sm text-zinc-400 transition-colors hover:bg-white/[0.08] hover:text-white"
        ...
        {showColumns && (
          <div className="absolute right-0 top-full z-20 mt-2 w-56 rounded-xl border border-white/[0.04] bg-[#1f1f1f] p-3 backdrop-blur-xl shadow-2xl">
      ...
      <div className="relative" ref={exportRef}>
        ...
        {showExportMenu && (
          <div className="absolute right-0 top-full z-20 mt-2 w-36 rounded-xl border border-white/[0.04] bg-[#1f1f1f] p-1.5 backdrop-blur-xl shadow-2xl">
            <button
              className="w-full rounded-lg px-3 py-2 text-left text-sm text-zinc-300 hover:bg-white/[0.08]"
              onClick={() => {
                onExport("csv")
                setShowExportMenu(false)
              }}
