...
interface ModalProps {
  ...
  size?: "sm" | "md" | "lg" | "xl" | "3xl" | "4xl" | "5xl" | "full" | "auto"
      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel
                className={`relative transform text-left transition-all sm:my-8 sm:w-full sm:mx-auto ${sizeClasses[size] || sizeClasses.md} max-h-[90vh] overflow-y-auto ${
                  isTransparent
                    ? "bg-transparent shadow-none p-0 border-none flex justify-center items-center"
