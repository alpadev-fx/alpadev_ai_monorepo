...
export default function Footer() {
  ...
  return (
    <footer className="bg-black backdrop-blur-md backdrop-saturate-150 w-full">
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div className="mt-8 border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4"> {/* Changed to flex-col/row for responsiveness */}
          ...
          <p className="mt-8 text-sm/6 text-gray-400 md:order-1 md:mt-0">
            &copy; {t("footer.madeBy")} - {new Date().getFullYear()} - {t("footer.rights")}
          </p>
        </div>
      </div>
    </footer>
