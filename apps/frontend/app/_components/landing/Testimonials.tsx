      ...
      <div className="relative z-10 flex flex-col gap-6">
          <div className="flex items-center gap-4">
              <div className="relative h-12 w-12 overflow-hidden rounded-full ring-2 ring-white/10">
                  <img src={testimonial.photoSrc} alt={testimonial.author} className="h-full w-full object-cover" />
              </div>
  ...
  return (
    <section ref={containerRef} className="relative bg-black py-32 overflow-hidden" id="testimonios">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 mb-20 text-center">
          <h2 className="text-5xl md:text-8xl font-bold tracking-tighter text-white mb-8 testimonials-title opacity-0 !leading-none">
