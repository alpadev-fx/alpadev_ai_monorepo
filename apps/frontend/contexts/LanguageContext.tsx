...
const translations = {
  en: {
    ...
    "terms.jurisdiction.desc": "This Agreement shall be governed by the laws of the Republic of Colombia. Any dispute shall be resolved before the competent courts of the city of Barranquilla, Atlántico, Colombia.",
